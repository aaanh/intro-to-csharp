...
namespace PrjCar
{
    public partial class FrmNagara : Form
    {
        ...
        private void shipSelectorToolStripMenuItem_Click(object sender, EventArgs e)
        {
