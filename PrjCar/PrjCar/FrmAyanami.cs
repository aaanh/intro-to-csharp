...
// REFER TO[OFFICIAL] HOANG ANH executable file if there is font error(Installed font is Roboto by Google)
  ...
  /// <summary>
  /// This is the original code that will be applied to other forms, with the same name on labels, buttons, pictureboxes, and etc.
  /// Enjoy the weebness of the program.
  /// </summary>
namespace PrjCar
{
    public partial class FrmAyanami : Form
    {
